...
!define BrandFullName         "Lale"
!define CompanyName           "Team AvdanOS"
!define URLInfoAbout          "https://www.example.org"
!define URLUpdateInfo         "https://www.example.org/Lale/${AppVersion}/releasenotes"
!define HelpLink              "https://support.example.org"

; The OFFICIAL define is a workaround to support different urls for Release and
; Beta since they share the same branding when building with other branches that
; set the update channel to beta.
!define OFFICIAL
!define URLStubDownloadX86 "https://download.example.org/?os=win&lang=${AB_CD}&product=lale-latest"
!define URLStubDownloadAMD64 "https://download.example.org/?os=win64&lang=${AB_CD}&product=lale-latest"
!define URLStubDownloadAArch64 "https://download.example.org/?os=win64-aarch64&lang=${AB_CD}&product=lale-latest"
!define URLManualDownload "https://www.example.org/${AB_CD}/lale/installer-help/?channel=release&installer_lang=${AB_CD}"
!define URLSystemRequirements "https://www.example.org/firefox/system-requirements/"
